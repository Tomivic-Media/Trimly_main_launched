...
$out = Join-Path $root 'trimly-social-21-carousel-barber-dashboard-v1.jpg'
$src = Join-Path $root 'trimly-social-07-barber-dashboard-ngn-v2.jpg'
...
$g.DrawString('Barber dashboards should drive the day clearly.',$headlineFont,$hb,(New-Object System.Drawing.RectangleF 56,118,760,96))
$g.DrawString('Barbers need to see earnings, approvals, bookings, services, and performance without hunting for information.',$subFont,$mb,(New-Object System.Drawing.RectangleF 58,224,800,72))

Card $g 150 314 780 900 34
ImgContain $g $src 182 346 716 836 26
$g.DrawString('This slide shows the barber side of the Trimly marketplace.',$footerFont,$mb,(New-Object System.Drawing.RectangleF 154,1234,760,44))
